...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Freelancer get freelancer {
    ...
    freelancer.mobile = int.parse(_mobileEditingController.text);
    freelancer.image = imageName!;
    // freelancer.experience = _experiences[_selectedExperienceId!-1].title;
    // freelancer.experiance = _facebookEditingController.text;
    // freelancer. = _linkedInEditingController.text;
